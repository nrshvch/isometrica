...
define('events/subscription',['require','exports','module'],function (require, exports, module) {
...
// Extracted verbatim from the pre-existing browserify bundle; AMD simplified
// CommonJS wrapper added so r.js can build it. Do not reformat the body.
define('events/event',['require','exports','module','./subscription'],function (require, exports, module) {
...
// Extracted verbatim from the pre-existing browserify bundle; AMD simplified
// CommonJS wrapper added so r.js can build it. Do not reformat the body.
define('events/main',['require','exports','module','./event','./subscription'],function (require, exports, module) {
